-- =============================================================================
-- Growwlytics: apply ALL migrations (fresh Supabase project)
-- =============================================================================
-- In Supabase Dashboard: SQL Editor → New query → paste this entire file → Run.
-- Use only on a new project, or if you have not run 001/002/003 before.
-- If tables already exist, run the individual files in supabase/migrations/ instead.
-- =============================================================================
...
-- ========== 003_instagram_posts_insights.sql ==========
-- =============================================================================
